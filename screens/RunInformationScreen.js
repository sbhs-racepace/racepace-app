    ...
    return(
      <View style={{flex:1, backgroundColor: Color.lightBackground}}>
        ...
        <View style={[STYLES.container, {alignItems:'center', justifyContent:'space-around', flex:1,}]}>
          ...
          <Text style={STYLES.text_style}>Goal Pace: {minuteSecondString(this.props.run.run_info.goal_pace)}</Text>
          <Text style={STYLES.text_style}>Duration: {minuteSecondString(this.props.run.run_info.estimated_duration)}</Text>
          <Text style={STYLES.text_style}>Total Distance: {Math.ceil(this.props.run.run_info.estimated_distance)} m</Text>
          <Text style={STYLES.text_style}>Kilojoules Burnt: {Math.ceil(this.props.run.run_info.estimated_energy)} Kj</Text>
